...
enum ClientGameState : int {
  CLIENT_STATE_LOGIN = 0,
  CLIENT_STATE_LOBBY = 1,
  CLIENT_STATE_GAME = 2,
  ClientGameState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ClientGameState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool ClientGameState_IsValid(int value);
constexpr ClientGameState ClientGameState_MIN = CLIENT_STATE_LOGIN;
constexpr ClientGameState ClientGameState_MAX = CLIENT_STATE_GAME;
constexpr int ClientGameState_ARRAYSIZE = ClientGameState_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ClientGameState_descriptor();
template<typename T>
inline const std::string& ClientGameState_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ClientGameState>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ClientGameState_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ClientGameState_descriptor(), enum_t_value);
}
inline bool ClientGameState_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ClientGameState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ClientGameState>(
    ClientGameState_descriptor(), name, value);
}
enum ActorType : int {
  NONE = 0,
  PLAYER = 1,
...
constexpr ActorType ActorType_MAX = EFFECT;
...
constexpr AIState AIState_MIN = IDLE;
constexpr AIState AIState_MAX = DEATH;
...
constexpr SkillType SkillType_MAX = SKILL_PROJECTILE_ATTACK;
...
constexpr WeaponType WeaponType_MAX = WEAPON_TYPE_BOOK;
...
constexpr ConsumableType ConsumableType_MAX = CONSUMABLE_TYPE_PORTION;
...
constexpr MoveDir MoveDir_MAX = DOWN_LEFT;
...
template <> struct is_proto_enum< ::Protocol::ClientGameState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::ClientGameState>() {
  return ::Protocol::ClientGameState_descriptor();
}
