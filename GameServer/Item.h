...
public:
	static std::shared_ptr<Item> MakeItem(Protocol::ItemInfo* itemInfo);
	static std::shared_ptr<Item> MakeItem(const Protocol::ItemInfo& itemInfo);

private:
	static std::shared_ptr<Item> CreateItem(const Protocol::ItemType& type);
